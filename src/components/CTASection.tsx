...
const CTASection = ({ onOpenPartner }: CTASectionProps) => {
  ...
  return (
    <section id="connect" className="py-32 md:py-60 section-padding relative overflow-hidden" ref={ref}>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
          ...
          >
            <p className="text-base text-foreground/60 max-w-xs font-body leading-relaxed">
              Join Ooma Labs in defining the future of high-impact technology systems.
            </p>
